# code here : https://www.kaggle.com/ppjanka/kaggle-prof-skills-1-climate-change-in-noaa-data
...
all_files = sorted(os.listdir("data_files"))
print(all_files[:5])
print(all_files[-5:])
print(len(all_files))

# import tarfile for .tar files
import tarfile
pathstem = "data_files"
print(all_files)

for f in all_files:
    with tarfile.open(pathstem + "/"+ f) as tar:
        i = 0
        for tarinfo in tar:
